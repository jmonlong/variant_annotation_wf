...
task subset_annotate_smallvars_with_db {
    ...
    command <<<
        ...
        SnpSift -Xmx~{snpsiftMem}g dbnsfp -v -db dbnsfp.txt.gz -f GERP++_RS,CADD_raw,CADD_phred,MetaRNN_score,MetaRNN_pred,ALFA_Total_AF ~{basen}.gnomad.clinvar.vcf | gzip > ~{basen}.gnomad.clinvar.dbnsfp.vcf.gz
    >>>
...
task annotate_noncoding_sv_with_db {
    input {
        File input_vcf
        File sv_db_rdata
        Int memSizeGB = 8
...
task validate_svs_with_vg {
    ...
    runtime {
        ...
        cpu: threadCount
        disks: "local-disk " + diskSizeGB + " SSD"
        docker: "quay.io/jmonlong/svvalidate_vgcall@sha256:6ca371f4b9229d8b8b38d03a20572be01c8b836e2cdc816dda262778bcdc2466"
        preemptible: 1
    }
}
