...
## args.i = unlist(strsplit('-v /private/groups/migalab/shnegi/CARD/vcf_annotation/annotation_smk_CARD/results/HBCC_81925_FTX/HBCC_81925_FTX.annot.vcf.gz -r /private/groups/migalab/shnegi/CARD/vcf_annotation/annotation_smk_CARD/results/HBCC_81925_FTX/HBCC_81925_FTX.tr.tsv.gz -rc /private/groups/migalab/shnegi/CARD/vcf_annotation/annotation_smk_CARD/references/hprc-hgsvc-tr-catalog.tsv.gz -d /private/groups/migalab/shnegi/CARD/vcf_annotation/annotation_smk_CARD/references/annotation_database.RData -a /private/groups/migalab/shnegi/CARD/vcf_annotation/annotation_smk_CARD/results/HBCC_81925_FTX/snpeff.HBCC_81925_FTX.svs.sveval.annotsv.tsv.gz', ' '))
...
## Entire annotated dataframe (gene impacts from snpeff)

```{r}
seff.sel = al.df.new %>% filter(gene_type=='protein_coding')
```

## Around enhancers of disease genes

```{r}
enh.sel = al.df.new %>% filter(ENHDIS>0)
```
